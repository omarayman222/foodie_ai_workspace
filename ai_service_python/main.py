...
def get_recommendations(request: PantryRequest):
    ...
    top_recipes = get_smart_recommendations(request.ingredients, request.allergies, request.diets, request.medical_conditions, request.dislikes, request.disliked_cuisines)
